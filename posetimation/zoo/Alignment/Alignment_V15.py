...
class Alignment_V15(nn.Module):
    ...
    def __init__(self, cfg, is_train, **kwargs):
        ...
        self.dcn_offset_2 = conv_bn_relu(48, n_offset_channel, 3, 1, padding=6, dilation=6, has_bn=False,
                                         has_relu=False)
        self.dcn_mask_2 = conv_bn_relu(48, n_mask_channel, 3, 1, padding=6, dilation=6, has_bn=False,
                                       has_relu=False)
        self.dcn_2 = DeformConv2d(48, 48, 3, padding=6, dilation=6)

        self.dcn_offset_3 = conv_bn_relu(48, n_offset_channel, 3, 1, padding=9, dilation=9, has_bn=False,
                                         has_relu=False)
        self.dcn_mask_3 = conv_bn_relu(48, n_mask_channel, 3, 1, padding=9, dilation=9, has_bn=False,
                                       has_relu=False)
        self.dcn_3 = DeformConv2d(48, 48, 3, padding=9, dilation=9)

        self.dcn_offset_4 = conv_bn_relu(48, n_offset_channel, 3, 1, padding=12, dilation=12, has_bn=False,
                                         has_relu=False)
        self.dcn_mask_4 = conv_bn_relu(48, n_mask_channel, 3, 1, padding=12, dilation=12, has_bn=False,
                                       has_relu=False)
        self.dcn_4 = DeformConv2d(48, 48, 3, padding=12, dilation=12)
    ...
    def forward(self, kf_x, sup_x, **kwargs):
        ...
        # print("combined_feat_shape: {}".format(combined_feat.shape))
        dcn_offset = self.dcn_offset_1(combined_feat)
        # print("dcn_offset1: {}".format(dcn_offset.shape))
        dcn_mask = self.dcn_mask_1(combined_feat)
        # print("dcn_mask1: {}".format(dcn_mask.shape))
        combined_feat = self.dcn_1(combined_feat, dcn_offset, dcn_mask)
        # print("combined_feat1: {}".format(combined_feat.shape))
